...
pub enum FileType {
    ...
    PS = 0x50532020u32,  /* 'PS  ', general PostScript following DSC conventions. */
    ...
    AEProjTemplate = 0x41455420u32,  /* 'AET ', After Effects Project Template */
...
extern "C" {
    ...
    pub fn xmp_files_open_new(p: *const c_char, options: u32 /*OpenFlags*/) -> *mut XmpFile;
    pub fn xmp_files_open(
        xf: *mut XmpFile,
        p: *const c_char,
        options: u32, /*OpenFlags*/
    ) -> bool;
    pub fn xmp_files_close(xf: *mut XmpFile, options: u32 /*CloseFlags*/) -> bool;
    ...
    pub fn xmp_iterator_next(
        ...
        name: *mut XmpString,
        value: *mut XmpString,
        option: *mut u32, /*IterFlags*/
    ) -> bool;
    pub fn xmp_iterator_skip(i: *mut XmpIterator, option: u32 /*IterSkipFlags*/) -> bool;
